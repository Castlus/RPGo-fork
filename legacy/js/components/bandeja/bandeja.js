 ...
 * @param {string} sessionId - ID da sessão (mesa ou personagem)
 * @param {Object} [personagemInicial] - Personagem já carregado pela ficha (passado pro chat-logic pra evitar refetch)
 */
import { iniciarRolador } from './rolador-logic.js';
import { iniciarChat }    from './chat-logic.js';
export function iniciarBandeja(user, sessionId = 'mesa-principal', personagemInicial = null) {
    ...
    // =========================================================
    const chatApi = iniciarChat(user, SESSION_ID, personagemInicial);
    iniciarRolador(user, {
