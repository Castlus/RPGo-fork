// Templates pré-definidos de calendário.
// Usados em `POST /api/mesas/:mesaId/calendario/aplicar-template`.

export const TEMPLATE_GREGORIANO = {
    meses: [
...
// Template inspirado em One Piece — Grand Line simbólico.
// 12 × 30 = 360 dias por ano, meses nomeados por marcos do mundo,
// dias da semana temáticos, anoEpoch = Era do Pirata Rei.
...
// Tipos de clima default — usados ao aplicar qualquer template com resetarTiposClima=true.
// Os nomes das estações nas chaves de `pesos` devem bater com os de Calendario.config.estacoes.
export const TIPOS_CLIMA_DEFAULT = [
